...
![Profile menu with Settings highlighted](images/01-open-settings.png)
...
![Settings sidebar with Billing and licensing highlighted](images/02-billing-and-licensing.png)
...
![Education benefits page with Start an application highlighted](images/03-education-benefits.png)
...
![Application form with each field numbered](images/04-application-form.png)
...
![Browser site settings with the Location toggle highlighted](images/05-allow-location.png)
...
![Upload step with the photo area and Submit Application highlighted](images/06-upload-proof.png)

## Step 7: Wait for the result

You should see **Your application has been submitted**.

![Confirmation message after submitting](images/07-submitted.png)
...
![Application status showing Pending](images/08-pending.png)
...
![Application status showing Approved, with the 72-hour wait highlighted](images/09-approved.png)
...
3. Tell GDG Seneca so we can update this guide.
